...
inline ::int32_t Image::channels() const {
  // @@protoc_insertion_point(field_get:Image.channels)
  return _internal_channels();
}
inline void Image::set_channels(::int32_t value) {
  _internal_set_channels(value);
  // @@protoc_insertion_point(field_set:Image.channels)
}
inline ::int32_t Image::_internal_channels() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.channels_;
}
inline void Image::_internal_set_channels(::int32_t value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
