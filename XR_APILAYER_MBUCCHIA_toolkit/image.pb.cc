...
const ::uint32_t TableStruct_image_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(
    ...
    PROTOBUF_FIELD_OFFSET(::Image, _impl_.channels_),
};
...
const ::_pbi::TcParseTable<2, 4, 0, 0, 2> Image::_table_ = {
  {
    0,  // no _has_bits_
    0, // no _extensions_
    ...
    // int32 channels = 4;
    {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(Image, _impl_.channels_), 63>(),
     {32, 63, 0, PROTOBUF_FIELD_OFFSET(Image, _impl_.channels_)}},
    // bytes data = 1;
    ...
    (0 | ::_fl::kFcSingular | ::_fl::kInt32)},
    // int32 channels = 4;
    {PROTOBUF_FIELD_OFFSET(Image, _impl_.channels_), 0, 0,
    (0 | ::_fl::kFcSingular | ::_fl::kInt32)},
  }},
  // no aux_entries
  {{
